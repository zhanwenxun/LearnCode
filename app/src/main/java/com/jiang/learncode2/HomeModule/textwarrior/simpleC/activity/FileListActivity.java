...
import com.jiang.learncode2.HomeModule.textwarrior.simpleC.adapter.FileListAdapter;
import com.jiang.learncode2.HomeModule.textwarrior.simpleC.entity.FileListItem;

import com.jiang.learncode2.HomeModule.textwarrior.simpleC.adapter.FileListAdapter;
import com.jiang.learncode2.HomeModule.textwarrior.simpleC.entity.FileListItem;
import com.jiang.learncode2.HomeModule.textwarrior.simpleC.util.ConstantPool;
import com.jiang.learncode2.HomeModule.textwarrior.simpleC.util.FileNameSort;
...
public class FileListActivity extends Activity {
    ...
    private Toast toast;
    private  final File HOME_PATH=new File(Environment.getExternalStorageDirectory().getAbsolutePath() + File.separator + "LearnCode");
    @Override
